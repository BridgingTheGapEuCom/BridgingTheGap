<template>
  <article>
    ...
    <p>
      ...
      developed over the years. Why do we need to communicate? Information has always been the key
      to everything humankind has done. The more information we had, the more power we could amass.
      Nowadays it is estimated that on average we consume about 34GB of media daily (not accounting
      for other information, not screen-related!). Most people do not do much with that information,
      as most of it is forgotten in the next few days. But just understanding the capacity of our
      brains to process and store data, kind of shows the "why". We are information hungry! We
      strive to exchange information all the time, because this is basically what we consume,
      whether it’s gossip, a TV drama, or actually useful knowledge!
    </p>
    <p>
      But going back to Application Integration. The most basic form of data exchange is a
    ...
    <p>
      ...
      the capability to provide the right data to the right place at the right time, where
      Application Integration defines how that data transfer should happen within those given
      parameters.
    </p>
    <p>
    ...
    <ul>
      ...
      <li>Requires highly trained Integration Architects to be successful,</li>
    </ul>
    <h2>So what is Application Integration?</h2>
    <p>
