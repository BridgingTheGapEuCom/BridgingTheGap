<template>
  <div
    class="flex-col items-center article snap-y overflow-auto snap-mandatory w-full min-w-full scroll-smooth text-black dark:text-white"
    style="max-height: calc(100dvh)"
  >
    <LandingPage1 />
    <LandingPage2 />
    <LandingPage3 />
